...
func validateService(service string) error {
	...
	if store.ReservedService(service) {
		if _, err := fmt.Fprintf(os.Stderr, "Service name %s is reserved for chamber's own use and will be prohibited in a future version. Please switch to a different service name.\n", service); err != nil {
